<?php 
    ...
    if(isset($_POST['create-donor'])){
        if(!isset($_POST['donor_name']) || empty($_POST['donor_name'])){
            echo json_encode(array('error'=>'Donor Name Field is Empty.')); exit;
            ...
            echo json_encode(array('error'=>'Pin Code Field is Empty.')); exit;
            ...
            echo json_encode(array('error'=>'Country Field is Empty.')); exit;
        }else if(!isset($_POST['blood_group']) || empty($_POST['blood_group'])){
            echo json_encode(array('error'=>'Blood Group Field is Empty.')); exit;
        }else{
            ...
            $result = $db->getResult();
            if(!empty($result)){
                echo json_encode(array('error'=>'Donor Email is already exist.')); exit;
            }else{
